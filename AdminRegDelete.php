    ...
    <header>
        ...
        <nav class="bg-dark" data-bs-theme="dark" style="height: 60px; width: 100%;">
            <ul class="nav justify-content-center mb-2 nav-tabs"><br>
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="AdminRegDelete.php">Delete</a>
                </li> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
            </ul>
        </nav>
    </header>
                    ...
                    <div class="col-lg-8 col-xl-6">
                        <div class="card rounded-3">
                            <div class="card-body p-4 p-md-5">
                                <h3 class="pb-md-0 mb-md-5 px-md-2">Delete Regiment Details</h3>
                                ...
                                <?php
                                    ...
                                    if (isset($_POST['btnDelete'])) {
                                        ...
                                        $sql = "DELETE FROM regiment WHERE regiment_id = ?";
                                ...
                                <form method="post" action="#">
                                    ...
                                    <button type="submit" class="btn btn-success" name="btnDelete" id="btnDelete">Delete</button>
                                </form>
                            </div>
                        </div>
                    </div>
